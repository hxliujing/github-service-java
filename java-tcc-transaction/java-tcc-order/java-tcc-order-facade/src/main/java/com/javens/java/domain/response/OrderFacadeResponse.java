 ...
 *
 * @author liujing01
 * @version OrderFacadeResponse.java, v 0.1 2019-01-02 14:28 
 */
public class OrderFacadeResponse implements Serializable {

    private static final long serialVersionUID = -8507765296383474315L;
