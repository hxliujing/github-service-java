...
public class SpringMybatisConfig {
    ...
    public static MapperScannerConfigurer lifeCircleConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.javens.java.service.dal.tcc_java_account");
    ...
    public SqlSessionFactoryBean lifeCircleSqlSessionFactory() throws IOException, SQLException {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:/com/javens/java/service/dal/tcc_java_account/mapper/*.xml"));
